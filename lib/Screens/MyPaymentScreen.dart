                                                      ...
                                                      data[index]["payment_status"] !=
                                                          ...
                                                          : RaisedButton(
                                                              onPressed:
                                                                ...
                                                                if (isWithdrawable) {
                                                                  var resData =
                                                                      await apiHelper.withdrawRequest(
                                                                          orderId:
                                                                              data[index]["order_id"]);
                                                                  data[index][
                                                                      "withdraw_message"] = resData[
                                                                          "data"]
                                                                      ["msg"];
                                                                  if (resData[
                                                                          "status"] ==
                                                                    ...
                                                                    newSetState(
                                                                        () => {
                                                                              data[index]["withdraw_message"] = "Request Sent",
                                                                              data[index]["payment_status"] = "1",
                                                                            });
                                                                  ...
                                                                  Get.snackbar(
                                                                      "Widthdraw",
                                                                      "It's look like you haven't provided your back detail. Kindly provide it on Profile Section to get paid",
                                                                      snackPosition:
                                                                          SnackPosition
                                                                              .BOTTOM,
                                                                      margin:
