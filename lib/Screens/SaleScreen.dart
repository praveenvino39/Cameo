                ...
                child: FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) => snapshot
                                    .data["my_sale"][index]["seller_status"] !=
                                "0"
                            ? ListTile(
                                tileColor: Colors.white,
                                title: Text(
                                    snapshot.data["my_sale"][index]["title"]),
                                leading: Text(snapshot.data["my_sale"][index]
                                    ["order_id"]),
                                trailing: Text(
                                ...
                                onTap: () {
                                  ...
                                  showModalBottomSheet(
                                    context: context,
                                    builder: (context) {
                                      log(snapshot.data["my_sale"][index]
                                          ["user_id"]);
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: FlatButton(
                                                      ...
                                                      onPressed: () async {
                                                        loading(context);
                                                        pickedFileResult = await FilePicker
                                                            .platform
                                                            .pickFiles(
                                                                onFileLoading:
                                                                    (status) =>
                                                          ...
                                                          if (data["message"]
                                                            ...
                                                            if (data["message"]
                                                              ...
                                                              _scaffoldKey
                                                                ...
                                                                SnackBar(
                                                                  content: Text(
                                                                    "File size limit exceeded, Please upload file below 5mb",
                                                                    style: TextStyle(
                                                                        color:
                                                                            kSecondaryColor),
                                                                  ),
                                                          ...
                                                          onChanged: value ==
                                                              ...
                                                              : (val) async {
                                                                  ...
                                                                  print(snapshot
                                                                      ...
                                                                      [
                                                                      "order_id"]);
                                                                  Map res = await ApiHelper().changeOrderStatus(
                                                                      orderId: snapshot.data["my_sale"]
                                                                              [
                                                                              index]
                                                                          [
                                                                          "order_id"],
                    ...
                    if (snapshot.hasError) {
                      return Text("${snapshot.error}Something went wrong");
                    } else {
                      return Center(
