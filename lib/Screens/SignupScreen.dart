...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void initState() {
    super.initState();
    //Getting data for country dropdownmenu
    apiHelper.country().then((value) => {
          setState(() => {countries = jsonDecode(value.body)})
        });
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                        ...
                        child: Theme(
                          ...
                          child: TextFormField(
                            validator: MinLengthValidator(1,
                                errorText: "Fullname should not be empty"),
                            onChanged: (value) =>
                      ...
                      Padding(
                        ...
                        child: DropdownButton(
                          ...
                          onChanged: (value) {
                            setState(() {
                              selectedCountry =
                                  countries[int.parse(value) - 1]["country"];
                      ...
                      Padding(
                        ...
                        child: DropdownButton(
                          ...
                          onChanged: (value) {
                            setState(() {
                              var e = states.firstWhere(
                                  (element) => element["state_id"] == value);
                ...
                height(200.0),
                Text("By signing up you're accepting our terms and conditions"),
              ],
            ),
          ),
        ),
