              ...
              children: [
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: DropdownButton(
                                  ...
                                  isExpanded: true,
                                  hint: snapshot.data[0]["profession"] == null
                                      ? Text(
                                          "Profession",
                                          style: kDropDownTextStyle,
                                        )
                                      : Text(
                                          snapshot.data[0]["profession_name"],
                                          style: kDropDownTextStyle,
                                        ),
                  ...
                  child: Container(
                    child: Theme(
                      ...
                      child: TextFormField(
                        ...
                        maxLines: 4,
                        minLines: 1,
                        initialValue: snapshot.data[0]["description"] != null
                  ...
                  child: Container(
                    child: Theme(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: snapshot.data[0]["contact"] != null
                        ...
                        focusNode: fnPhone,
                        decoration:
                            kEditFieldDecoration.copyWith(labelText: "Phone"),
                        style: TextStyle(
                          fontSize: 17,
                          color: Colors.white,
                        ),
                ...
                Padding(
                  ...
                  child: Container(
                    child: Theme(
                      ...
                      child: TextFormField(
                        readOnly: true,
                        initialValue: snapshot.data[0]["email"] != null
                        ...
                        focusNode: fnEmail,
                        decoration:
                            kEditFieldDecoration.copyWith(labelText: "Email"),
                        style: TextStyle(
                          fontSize: 17,
                          color: Colors.white,
                        ),
                ...
                Padding(
                  ...
                  child: DropdownButton(
                    ...
                    hint: language != null
                        ...
                        : Text(
                            snapshot.data[0]["lang_speaks"] != null
                  ...
                  child: Container(
                    child: Theme(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            kEditFieldDecoration.copyWith(labelText: "City"),
                        style: TextStyle(
                          fontSize: 17,
                          color: Colors.white,
                        ),
                ...
                Padding(
                  ...
                  child: FlatButton(
                    onPressed: () async {
                      loading(context);
                      bool isUpdated = await _apiHelper.updateUserDetail(
                          ...
                          city: city != null ? city : snapshot.data[0]["city"],
                      ...
                      if (isUpdated) {
                        ...
                        Get.defaultDialog(
                            ...
                            middleText:
                                "You've successfully updated you profile detail, you need to login again.",
                            actions: [
                              RaisedButton(
